...
class MainActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private fun sendParameters() {
        if(!isFilledAllFields()){
            MDToast.makeText(this,getString(R.string.fill_all_fields),MDToast.LENGTH_LONG,MDToast.TYPE_ERROR).show()
            return
        }
        if(isValidAllFields()){
            ...
            Log.e("phone::",devicePhoneNumberEdit?.text.toString())
        }
    ...
    private fun isValidAllFields(): Boolean {
        ...
        if(delayConEdit?.text.toString().toInt()>240){
            ...
            MDToast.makeText(this,getString(R.string.low_from_240),MDToast.LENGTH_LONG,MDToast.TYPE_ERROR).show()
            return false
        }else{
